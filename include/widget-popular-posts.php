...
/*-----------------------------------------------------------------------------------
  ...
  Description: Displays popular blog posts with images from a standard post type.
  Version: 1.0
...
add_action( 'widgets_init', 'zebras_popular_blog_posts' );


function zebras_popular_blog_posts() {
  register_widget( 'Zebras_Popular_Blog_Posts' );
}

class Zebras_Popular_Blog_Posts extends WP_Widget {

  function Zebras_Popular_Blog_Posts() {
    $widget_ops = array( 'classname' => 'example', 'description' => __('A widget that displays popular posts with thumbs ', 'example') );
  ...
  function widget( $args, $instance ) {
    ...
    if ( $number > 0 )
      ...
      $args = array(
      'numberposts'  => $number,  /* get 4 posts, or set -1 for all */
  ...
  function form( $instance ) {
    ...
    $defaults = array( 'title' => __('Popular posts', 'example'), 'number' => __('4', 'example'),'image_size' => __('50', 'example'), 'show_info' => true );
