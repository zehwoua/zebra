...
//echo $admin;
$theme_root = explode ("/", $root);
$count = count($theme_root)-1;

$link = "http://".$_SERVER[HTTP_HOST].'/'.$theme_root[$count];
...
<script type="text/javascript" src="<?php echo $link; ?>/wp-includes/js/tinymce/tiny_mce_popup.js"></script>

<style type="text/css" src="<?php echo $admin; ?>wp-includes/js/tinymce/themes/advanced/skins/wp_theme/dialog.css"></style>
<link rel="stylesheet" href="includes/css/zebras_buttons_tinymce.css" />
